...
def execute_no_result(sql_sentence: str, param_tuple: ()) -> None:
    print(str(__name__) + ".class.execute_no_res-sql_sentence: ", sql_sentence)
...
def execute_fetch_records(sql_sentence: str, param_tuple: ()) -> list:
    print(str(__name__) + ".class.execute_fetch_records-sql_sentence: ", sql_sentence)
    con = connected.connect_database()
    cur = con.cursor()
    ...
    print(str(__name__) + ".class.execute_fetch_records-results: ", results)
